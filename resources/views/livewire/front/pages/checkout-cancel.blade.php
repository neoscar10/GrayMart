                    ...
                    <div class="card-body p-24 text-center">
                        <div class="mb-12">
                            <span
                                ...
                                <i class="ph ph-x text-white" style="font-size:32px;"></i>
                            </span>
                        </div>
                        <h3 class="mb-6">Payment Canceled</h3>
                        <p class="text-muted">You canceled the payment on PayPal. Your orders remain
                            <strong>unpaid</strong> (and marked as cancelled if still pending).</p>

                        @if(!empty($vendorCards))
                            <div class="border rounded-12 p-16 text-start my-16">
                                <div class="d-flex justify-content-between">
                                    <span class="fw-semibold">Grand (attempted)</span>
                                            ...
                                            <div class="border rounded-12 p-12 h-100">
                                                <div class="d-flex align-items-center gap-10 mb-8">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted">Order #{{ $card['order_id'] }} —
                                                            {{ ucfirst($card['status']) }}</small>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-10 justify-content-center mt-20">
                            <a href="{{ route('checkout') }}"
                                class="btn bg-main-600 hover-bg-main-700 text-white rounded-12 px-16">Try Again</a>
