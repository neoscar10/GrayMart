                                ...
                                <tbody>
                                    @forelse ($cart_items as $item)
                                        @php
                                            ...
                                            $isAuction = !empty($item['is_auction']) || (!empty($item['meta']['is_auction']) ?? false);
                                            $img = !empty($item['image']) ? asset('storage/' . $item['image']) : asset('assets/images/thumbs/product-placeholder.png');
                                        @endphp
                                        <tr>
                                            <!-- Remove Button -->
                                            <td class="align-middle">
                                                <button
                                                    wire:click='removeItem({{ $item["product_id"] }}, @json($variantId))'
                                                    type="button"
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if($item['variant_label'] ?? false)
                                                            <div class="text-xs text-muted">{{ $item['variant_label'] }}</div>
                                                        @endif
                                                        @if($isAuction)
                                                            <div class="mt-1">
                                                                <span
                                                                    class="badge bg-warning-subtle text-warning border border-warning rounded-pill px-8 py-4">
                                                                    Auction
                                                                    @if(($item['meta']['source'] ?? '') === 'winner')
                                                                        — Winning Bid
                                                                    @elseif(($item['meta']['source'] ?? '') === 'buy_now')
                                                                        — Buy Now
                                                                    @endif
                                                                </span>
                                                            </div>
                                            ...
                                            <td class="align-middle">
                                                @if($isAuction)
                                                    <span class="px-3 fw-semibold text-dark">1</span>
                                                @else
                                                    <div class="d-inline-flex align-items-center gap-2">
                                                        <button type="button"
                                                            wire:click='decreaseQty({{ $item["product_id"] }}, @json($variantId))'
                                                        ...
                                                        <button type="button"
                                                            wire:click='increaseQty({{ $item["product_id"] }}, @json($variantId))'
                                                            wire:loading.attr="disabled" class="btn btn-outline-main btn px-10">
                                                            &#43;
                                                        </button>
                                                    </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-secondary">No items in cart</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                    ...
                    <div class="cart-sidebar border border-gray-100 rounded-8 px-24 py-40">
                        ...
                        <div class="bg-color-three rounded-8 p-24">
                            <div class="mb-32 flex-between gap-8">
                                ...
                                <span class="text-gray-900 fw-semibold">${{ number_format($grand_total, 2) }}</span>
                            </div>
                            <div class="mb-32 flex-between gap-8">
        ...
        <div class="container container-lg">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <div class="shipping-item flex-align gap-16 rounded-16 bg-main-50 hover-bg-main-100 transition-2">
                        <span class="w-56 h-56 flex-center rounded-circle bg-main-600 text-white text-32 flex-shrink-0">
                            <i class="ph-fill ph-car-profile"></i></span>
                        <div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="shipping-item flex-align gap-16 rounded-16 bg-main-50 hover-bg-main-100 transition-2">
                        <span class="w-56 h-56 flex-center rounded-circle bg-main-600 text-white text-32 flex-shrink-0">
                            <i class="ph-fill ph-hand-heart"></i></span>
                        <div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="shipping-item flex-align gap-16 rounded-16 bg-main-50 hover-bg-main-100 transition-2">
                        <span class="w-56 h-56 flex-center rounded-circle bg-main-600 text-white text-32 flex-shrink-0">
                            <i class="ph-fill ph-credit-card"></i></span>
                        <div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="shipping-item flex-align gap-16 rounded-16 bg-main-50 hover-bg-main-100 transition-2">
                        <span class="w-56 h-56 flex-center rounded-circle bg-main-600 text-white text-32 flex-shrink-0">
                            <i class="ph-fill ph-chats"></i></span>
                        <div>
